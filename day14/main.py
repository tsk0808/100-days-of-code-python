...
def profile():
    '''
    50개의 Sample game_data 중 랜덤으로 한 개 선택

    name, folloe_count,description,country 추출 후 표시 스트링과 follower_count 반환
    '''
...
def higher_lower():
    ...
    while correct:
        ...
        # 둘 중 누가 Follower 많을지 사용자로 부터 추측 값 받음
        a_or_b = input(
